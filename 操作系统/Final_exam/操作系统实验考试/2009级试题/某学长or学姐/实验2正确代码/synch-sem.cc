...
// of liability and disclaor enabled).
//
// Copyright (c) 1992-1993 The Regents of the University of California.
// All rights reserved.  See copyright.himer of warranty provisions.
...
Condition::~Condition() { delete sem; }
